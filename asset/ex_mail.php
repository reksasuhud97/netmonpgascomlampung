...
function sendMail($x) {     
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'netmonpgas@gmail.com'; // Email anda disini
    $mail->Password = 'adminnetmon'; // Katasandi email anda
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587; 
    $mail->From = 'netmonpgas@gmail.com'; // Email disamakan saja
    $mail->FromName = 'Monitoring';
    $mail->addAddress('reksasuhud@gmail.com', 'reksa'); // Target email
     
    $mail->addReplyTo('netmonpgas@gmail.com', 'netmon'); // isi saja sama seperti email yg anda gunakan untuk mengirim
