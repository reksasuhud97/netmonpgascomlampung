                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                         <div class="input-group">
                          ...
                          <select class="form-control select2" style="width: 100%;" name="kantor">';
                          ...
                          <br />
                          <br />
                          <a href="./add_kantor" title="Add kantor">Add kantor</a>
                        </div>
                      </div>
                  </div>
                ...
                <div class="modal-content">
                  ...
                  <input type="hidden" name="id_st" value="<?php echo "$id_blok"; ?>">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group">
                            ...
                            <input type="text" value="<?php echo $name_blok; ?>" class="form-control" name="name_st" placeholder="Nama Kantor" required>
                          </div><!-- /.input group -->
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputTelp" class="col-sm-2 control-label">Telp Kantor</label>
                        <div class="col-sm-10">
                          <div class="input-group">
                            <div class="input-group-addon">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="add_st" rows='10' placeholder='Alamat Kantor' required><?php echo "$add_blok"; ?></textarea>
                        </div>
                      </div>
                      <!-- / Form edit -->
                  </div>
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="edit_kantor">Simpan</button>
                    </form>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div>
<!-- / Modal delete info kantor -->
<div class="modal modal-success fade" id="delSt">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Semua data client dengan nama kantor<strong><?php echo "$name_blok"; ?></strong> juga akan dihapus.</p>
                  </div>
                  <div class="modal-footer">
