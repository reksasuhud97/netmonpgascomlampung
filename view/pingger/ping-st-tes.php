...
if ($cek_page->num_rows != 0) {
    ...
    if ($r->num_rows!==0) {
            ...
            while ($client=$r->fetch_assoc()) {
                ...
                //kasi perintah ke shell untuk melakukan ping 
                if($status==0) {
                        ...
                        $hasil1 = trim($cut['1'], " .");
                            switch ($hasil1) {
                                ...
                                case 'Destination host unreachable':
                                    ...
                                    $status="<button type='button' class='btn btn-warning btn-circle'>
                                    <i class='fa fa-question-circle'></i>
                                    </button>&nbsp;<font color='#F0AD4'>$log</font>";
                                    break;
            ...
            echo "<div class='alert alert-warning'><strong>Tidak ada Data perangkat untuk ditampilkan!</strong></div>";
