...
<ul class="nav nav-tabs">
  ...
  <li class=""><a href="#kantor-info" data-toggle="tab" aria-expanded="true">Info Kantor</a></li>
  <li class=""><a href="#kantor-sett" data-toggle="tab" aria-expanded="false">Setting</a></li>
</ul>
<div class="tab-content">
  <div class="tab-pane active" id="tab-monitoring">
    <img src="./lib/img/loading.gif" id="loaderIcon" style="display:none" />
    <div id="monitoring"></div>
  </div><!-- /.tab-pane -->
  <div class="tab-pane" id="kantor-info">
    <!-- The timeline -->
       <?php 
    ...
    <div class="panel-body">
        <ul>
            <li>Nama kantor     : <strong><?php echo $name_blok; ?></strong></li>
            <li>Alamat          : <strong><?php echo $add_blok; ?></strong></li>
            <li>No.Telpon	    : <strong>+<?php echo $telp_blok; ?></strong></li>
            <li>Jumlah Perangkat	: <strong><?php echo $total_pc; ?> Perangkat</strong></li>
        </ul>
    </div>
  </div><!-- /.tab-pane -->

  <div class="tab-pane" id="kantor-sett">
     <button class='btn btn-warning btn-sm' data-toggle='modal' data-target='#editSt'>
...
include 'modal.php';
    ...
    echo '<div class="col-md-12">
        ...
        while ($get = $query->fetch_assoc()) {
            extract($get);
            echo "<li><a href='./kantor&id=$id_blok'><h5><i class='glyphicon glyphicon-briefcase'></i>&nbsp;&nbsp; $name_blok</h5></a></li>";
            echo '';
        }
    echo"</ul>
                </div><!-- /.box-body -->
